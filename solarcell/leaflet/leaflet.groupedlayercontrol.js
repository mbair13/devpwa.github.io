...
L.Control.GroupedLayers = L.Control.extend({
  ...
  onAdd: function (map) {
    this._initLayout();
    this._addButton();// add close button
    this._update();
  ...
  _addButton: function () {
    ...
    var separate = L.DomUtil.create('div', 'leaflet-control-layers-separator', elements[0]); //เน€เธเธดเนเธกเน€เธชเนเธเธเธฑเนเธ
    var button = L.DomUtil.create('button', 'my-button-class center-block', elements[0]); //เน€เธเธดเนเธกเธเธธเนเธก
